            ...
            <div class="Header_Table">
             ...
             <div class="flex-container">
                ...
                <div class="second_child">
                    ...
                    <script
                         src="https://maps.googleapis.com/maps/api/js?key=KEY_HERE" type="text/javascript">
                    </script>
            ...
            <div class="Header_Table">
             ...
             <div class="flex-container">
                ...
                <div id="container">
                    ...
                    <script
                         src="https://maps.googleapis.com/maps/api/js?key=KEY_HERE&callback=initDirMap&v=weekly" type="text/javascript">
                    </script>
                    </div>
                    <div class = "second_col_legend"><table>
<tr>
